...
setwd("Y:/aguisan/bryophyte/D2c/AlpineBryophytes")
library(vegan)
library(ecospat)
library(rdacca.hp)
library(ade4)
...
bryoTraits <- read.csv("DatasetsToUse_Cleaned/paper_STOTEN/Bryophytes_Traits_SpRichness.csv",row.names=1)
...
TracheoEnv <- read.csv("DatasetsToUse_Cleaned/paper_STOTEN/EnvDataForTracheophytes.csv",row.names = 1)
